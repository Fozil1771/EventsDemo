...
namespace DemoLibrary
{
    ...
    {
        public event EventHandler<string> TransactionApporovedEvent;
        public event EventHandler<decimal> OverdraftedEvent;
        ...
        public bool AddDeposit(string depositName, decimal amount)
        {
            ...
            Balance += amount;
            TransactionApporovedEvent?.Invoke(this, depositName);
            return true;
        }
        ...
        public bool MakePayment(string paymentName, decimal amount, Account backupAccount = null)
        {
            ...
            if (Balance >= amount)
            {
                ...
                Balance -= amount;
                TransactionApporovedEvent?.Invoke(this, paymentName);
                return true;
            }
            else
            {
                ...
                if (backupAccount != null)
                {
                    ...
                    if ((backupAccount.Balance + Balance) > amount)
                    {
                        ...
                        Balance -= amount;
                        TransactionApporovedEvent?.Invoke(this, paymentName);
                        OverdraftedEvent?.Invoke(this, amountNeeded);
                        return true;
                    }
                    else
                    {
